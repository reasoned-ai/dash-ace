...
export class NormHighlightRules extends window.ace.acequire("ace/mode/text_highlight_rules").TextHighlightRules
{
  constructor() {
      super();
      const keywords = (
          "and|or|not|except|unless|imply|in|" +
          "as|from|to|import|export|return|" +
          "for|exist|with|" +
          "any|all|this|that|super|self|sub|"
      );
...
export default class NormMode extends window.ace.acequire("ace/mode/python").Mode
{
  constructor() {
    super();
    const PythonFoldMode = window.ace.acequire("ace/mode/folding/pythonic").FoldMode;
    this.HighlightRules = NormHighlightRules;
